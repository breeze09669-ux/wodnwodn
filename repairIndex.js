...
const startIndex = html.indexOf('<option value="en" selected>English</option>');
const endIndex = html.indexOf('<!-- Categories & List -->');

if (startIndex !== -1 && endIndex !== -1) {
  const newMiddle = `<option value="en" selected>English</option>
  ...
  html = html.substring(0, startIndex) + newMiddle + html.substring(endIndex);
